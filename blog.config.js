...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Saydric Zheng', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://SaydricZheng-Blog.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'University of Waterloo, Computer Science, Personal Blog, SWE', // 网站关键词 英文逗号隔开
  ...
  ...require('giscus./conf/comment.config'), // 评论插件
  ...
  GREETING_WORDS:
    ...
    'Hi，I'am Saydric Zheng. Welcome to my Blog !',
